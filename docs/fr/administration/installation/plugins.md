...
| `prompt-guard`      | PRE_REQUEST, POST_RESPONSE, TOOL_RESULT_INSPECTOR | Prompt injection risk (rules + structural signals + embedded model, no LLM call); inspects request, tool results and the answer; optional block/redact |
